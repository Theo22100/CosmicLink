...
<body id="background">
    ...
    <div class="ui hidden" id="ui">
        <svg class="icon" xlmns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" fill="none" role="img" onclick="closeStarGui()">
    ...
    <div class="ui hidden" id="galaxyUi">
        <svg class="icon" xlmns="http://www.w3.org/2000/svg" viewBox="0 0 25 25" fill="none" role="img" onclick="closeGalaxyGui()">
